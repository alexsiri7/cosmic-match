...
void main() {
  testWidgets('tablet10_1 — fresh board (seed 42)', (tester) async {
    ...
    expect(game.phase, GamePhase.idle, reason: 'tablet10_1 must capture a settled board');
    await expectLater(
      find.byKey(gameKey),
  ...
  testWidgets('tablet10_2 — mid-cascade (match cleared, gravity in flight)', (tester) async {
    ...
    expect(
      ...
      reason: 'tablet10_2 must capture mid-cascade, not a settled board',
    );
  ...
  testWidgets('tablet10_3 — post-refill settled board', (tester) async {
    ...
    expect(
      game.phase,
      GamePhase.idle,
      reason: 'tablet10_3 must capture a settled board, not mid-cascade',
    );
